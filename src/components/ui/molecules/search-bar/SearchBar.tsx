...
export const SearchBar = ({
  ...
  const animatedCancelStyle = useAnimatedStyle(() => {
    ...
    const width = interpolate(focusProgress.value, [0, 1], [0, cancelButtonWidth]);
    return {
      opacity,
      width,
  ...
  return (
    <View style={[styles.container, style]} onLayout={handleLayout}>
      <View style={styles.searchRow}>
        ...
        >
          <BlurView intensity={15} tint="systemChromeMaterial" style={styles.blurContainer}>
                ...
                {query.length > 0 && (
                  ...
                  >
                    {renderTrailingIcons ? (
                      ...
                      <CircleX size={18} color="#8E8E93" fill="#8E8E93" />
                    )}
                  </AnimatedTouchable>
                )}
              </AnimatedView>
