...
import { darkColors, DEFAULT_ANIMATION_DURATION, DEFAULT_ANIMATION_TYPE, DEFAULT_EASING, lightColors } from './conf';
import { ThemeSwitcher } from './theme';

const ThemeContext = createContext<ThemeContextType | undefined>(undefined);

export const ThemeProvider = memo(function ReacticxThemeProvider({
  children,
  ...
  const colors: ThemeColors = theme === ThemeMode.Dark ? mergedDarkColors : mergedLightColors;
